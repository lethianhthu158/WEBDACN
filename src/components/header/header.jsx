      ...
      <div className="wrapHead">
        ...
        <div className="headerPart2">
          <div className="control left">
            ...
            <hr className="tap-control"></hr>
          </div>
          <div className="control">
            <button className="Tab Product">PRODUCTS</button>
          </div>
          <div className="control">
            <button className="Tab DisChannel">DISTRIBUTION CHANNEL</button>
          </div>
          <div className="control">
            <button className="Tab About">ABOUT US</button>
          </div>
